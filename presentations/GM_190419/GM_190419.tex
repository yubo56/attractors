...
\begin{frame}
    ...
    \begin{figure}[t]
        \centering
        \includegraphics[width=0.7\textwidth]{../../initial/0_eta/1contours.png}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{figure}[t]
                \centering
                \includegraphics[width=\textwidth]{../../initial/0_eta/4_01contour.png}
...
\begin{frame}
    ...
    \begin{figure}[t]
        \centering
        \includegraphics[width=0.65\textwidth]{../../initial/0_eta/3stats3_5_0_1.png}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.47\textwidth}
            \begin{figure}[t]
                \centering
                \includegraphics[width=\textwidth]{../../initial/0_eta/4singles.png}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.47\textwidth}
            \begin{figure}[t]
                \centering
                \includegraphics[width=\textwidth]{../../initial/0_eta/3stats2_0_0_1.png}
            \end{figure}
        \end{column}
        \begin{column}{0.47\textwidth}
            \begin{figure}[t]
...
\begin{frame}
    ...
    \begin{figure}[b]
        \centering
        \includegraphics[width=0.5\textwidth]{../../initial/0_eta/3stats3_5_0_2.png}
    \end{figure}
\end{frame}
