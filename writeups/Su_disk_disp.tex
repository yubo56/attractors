...
adiabaticity, we use $\epsilon = 3 \times 10^{-4}$ in our ``adiabatic''
...
is somewhat indirect but yields good agreement with numerical results.
...
condition is CS2). Thus
\begin{align}
    \sin\theta_{\rm f} &\simeq \sin I \abs{1 + e^{-i\varphi_0}
...
For $\theta_{\rm sd, i}\neq 0$, the set of possible initial conditions forms a
ring of angular radius $\theta_{\rm sd, i}$ about $\uv{l}_{\rm d}$ (or CS2). We
find that this set of initial conditions approximately evolves under
nonadiabatic evolution to a ring of angular width $\theta_{\rm sd, i}$ about the
$\theta_{\rm sd, i} = 0$ result given by Eq.~\eqref{eq:theta_2f}. Intuitively,
because of the rapid precession of $\uv{l}$ around $\uv{l}_d$ at $\eta = \eta_i
\gg 1$, the initial $\theta_i$ varies rapidly but is centered around $\theta_i
\simeq I$. Thus the final obliquity spans in the range
\begin{equation}
    \abs{\sqrt{\frac{2\pi \cos I}{\epsilon}}\sin I
            - \sin\theta_{\rm sd, i}}
        \lesssim \sin\theta_{\rm f}
        \lesssim
            \sqrt{\frac{2\pi \cos I}{\epsilon}}\sin I + \sin \theta_{\rm sd, i}
