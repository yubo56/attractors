...
phase (i). Deviations from this approximation occur when $\theta_{\rm sd, i}$ is
sufficiently large that libration cycles become non-circular as $\eta$ decreases
(Fig.~\ref{fig:eq_1contours} illustrates that libration cycles farther from CS2
are less circular).
...
obliquity, so the range of obliquities when the spin vector stops tracking CS2
is frozen in as the range of final obliquities.}
