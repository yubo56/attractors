...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{../initial/1_weaktide/6equils.png}
...
% \textcolor{red}{Just a brief investigation:} Finally, we briefly consider the
% possibility of tidal heating. Coarsely, we have that
% \begin{align}
%     \frac{\dot{a}}{a} &\sim -\frac{1}{10^{14}\;\mathrm{yr}}\p{1 -
%         \frac{\Omega_{\rm s}}{n}\cos \theta},\\
%     \dot{E}_{\rm orb} = \frac{GM_{\star}m}{2a}\frac{\dot{a}}{a}
%         &\approx 10^{20}\;\mathrm{erg/s}\p{1 -
%         \frac{\Omega_{\rm s}}{n}\cos \theta}.
% \end{align}
% The black body luminosity of the planet is expected to be $4 \times
% 10^{25}\;\mathrm{erg/s}$ for the fiducial parameters, and so can probably be
% ignored.
...
% (1 + 15/8 * (1.3)^(-4/3) + 175/64 * 1.3^(-8/3)) * 0.012
\begin{align}
...
% (G * (1.36 Msun) / (0.125 AU))^(1/2) * (105 Mearth) / (1.36 Msun) / 2^(1/2)
% 16.106 m/s
\begin{equation}
