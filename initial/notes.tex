...
Consider canonical coordinates $x = \sin \frac{\theta}{2}\cos \phi, y = \sin
\frac{\theta}{2}\sin \phi$, then the Hamiltonian can be written
\begin{align}
    H &= -\frac{1}{2}\cos^2\theta
        ...
        &= -\frac{1}{2}\p*{1 - 2\sin^2\frac{\theta}{2}}^2
            ...
            ,\nonumber\\
        &= -\frac{1}{2}\p*{1 - 2\p*{x^2 + y^2}}^2
            + \eta\p*{\p*{1 - 2\p*{x^2 + y^2}}\cos I
                - 2\sin I x\sqrt{1 - \p*{x^2 + y^2}}}.
\end{align}
