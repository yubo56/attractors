...
inclination $\hat{s} \cdot \hat{l}_p$ ($J_i = 2\pi\p*{1 - \cos \epsilon}$ where
$\epsilon$ is the initial mutual inclination). To do this, we need to understand
what the possible transitions are. When the separatrix first appears to the
final state, the transitions are $A_2 \to A_3, A_2 \to A_1, A_3 \to A_1, A_3 \to
A_2 \to A_1, A_3 \to A_3$. Let's reproduce the analytical forms of these three
areas below:
