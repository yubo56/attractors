...
\begin{align}
    \omega_{s1} &= \frac{3k_{qp}}{2k_p}\p*{\frac{R_1}{a_1}}^3s,\\
        &\approx 0.011\;\mathrm{yr^{-1}}
    ...
    \omega_{1p} &= \frac{3m_p}{4m_1} \frac{a_1}{a_p\p*{1 - e_p^2}} \Omega_1,\\
        &\approx 0.017\;\mathrm{yr^{-1}}
            \frac{m_p/m_1}{0.003}
            \p*{\frac{a_1/a_p}{0.01}}
            \frac{\Omega_1}{2\pi / 3\;\mathrm{days}}
            \frac{1}{1 - e_p^2}.
\end{align}
So with a bit of tweaking, we can barely get $\omega_{1p} \lesssim \omega_{s1}$.
Recall that $\eta = \frac{\omega_{1p}\cos I}{\omega_{s1}}$, which here $\sim 1$.
We simulated above for initial conditions $\frac{s_c}{s} = \eta \sim 0.1$, which
grows as $s$ spins down. This implies $\frac{s_c}{\Omega_1} \sim 1000$
though\dots
