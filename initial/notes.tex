...
% (1e-3 * (Msun / (8 Mearth))^3 * ((2 Rearth) * (0.05 AU))^(9/2))^(1/9) / (1 AU)
% = 0.033198
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw[->] (0, 0)--(-1.2, 5);
        \node[above left] at (-1.2, 5) {$L$};
        \draw[->] (0, 0)--(1.2, 0.2);
        \node[above right] at (1.2, 0.2) {$L_{\rm p}$};
        \draw[->] (0, 0)--(0, 5.2);
        \node[above] at (0, 5.2) {$J$};
        \draw[->, dashed] (-1.2, 5) -- (0, 5.2);
        \node[above] at (-0.2, 1.6) {$i$};
        \node[above right] at (0, 0) {$i_{\rm p}$};
        \node[below left] at (0, 5.2) {$i_{\rm p}$};
        \node[right] at (-1.2, 4.8) {$I$};
    \end{tikzpicture}
...
\begin{align}
    \eta_{\rm sync} &\approx
        ...
        &\approx
            ...
            \p{\frac{a}{R}}^3\cos I\nonumber\\
        &\approx
% 1/2 * (1.41 Mjup)^2 / (1.36 Msun)^2 * ((0.023 AU) / (1.89 Rjup))^3 * (0.023 / 0.05)^(3.5)
...
% 1 / (1.5 * 1e-7 * (1.36 Msun) / (1.41 Mjup) * ((1.89 Rjup) / (0.023 AU))^5 * (G * (1.36 Msun) / (0.023 AU)^3)^(1/2) * (1 yr))
...
%(G * (1.36 Msun) / (0.05 AU))^(1/2) * (50 Mearth) / (1.36 Msun) / 2^(1/2)
...
% (3/4 * ((1.41 * Mjup) / (1.36 * Msun))^3 * (1/3) * 1e6 * ((0.023 AU) / (1.89 Rjup))^(9/2))^(4/21)
% = 3.3469
...
% 1/2 * (1.41 Mjup)^2 / (1.36 Msun)^2 * ((0.038 AU) / (1.89 Rjup))^3 * (0.038 / 0.049)^(3.5)
% 0.016
\begin{equation}
    \eta_{\rm sync} = 0.016 \cos I\p{\frac{m}{1.41M_J}}^2
            ...
            \p{\frac{R}{1.89R_{J}}}^{-3}.
\end{equation}
% 1/2 * (Mjup)^2 / (Msun)^2 * ((0.04 AU) / Rjup)^3 * (0.04 / 0.08)^(3.5)
