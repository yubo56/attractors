...
Consider again the precession frequencies (we will take a hot Jupiter at
$0.1\;\mathrm{AU}$ and a cold Earth at $1\;\mathrm{AU}$, roughly)
\begin{align}
    \omega_{s1} &= \frac{3k_{qp}}{2k_p}\frac{M_*}{m_1}
            \p*{\frac{R_1}{a_1}}^3s,\\
        &\approx 0.062\;\mathrm{yr^{-1}}
            \p*{\frac{M_*/m_1}{300}}
            \p*{\frac{5.5 k_{qp}}{k_p}}\p*{\frac{R_1}{R_J}}^3
                \p*{\frac{a_1}{0.1\;\mathrm{AU}}}^{-9/2}
                \p*{\frac{s/\Omega_1}{10}},\\
    \omega_{1p} &= \frac{3m_p}{4m_1} \p*{\frac{a_1}{a_p\p*{1 - e_p^2}}}^3
            \Omega_1,\\
        &\approx 0.0047\;\mathrm{yr^{-1}}
            \frac{m_p/m_1}{0.003}
            \p*{\frac{a_1/a_p}{0.1}}
            \frac{\Omega_1}{2\pi / 11.54\;\mathrm{days}}
            \frac{1}{\p*{1 - e_p^2}^3}.
\end{align}
Note then that $s_c$ is where $\omega_{s1} = \omega_{1p}$, which is satisfied
for $s_c \approx 0.76$.
